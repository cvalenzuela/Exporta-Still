...
public class MercatorMap {
  // -170,-60,180,83
  // Para mapa negro/celeste -150,-60,180,70 a 1300 x 687px
  // Para mapa negro@3450: -161.0156,-62.9152,180,74.2120
  public static final float DEFAULT_TOP_LATITUDE = 74.2120;
  public static final float DEFAULT_BOTTOM_LATITUDE = -62.9152;
  public static final float DEFAULT_LEFT_LONGITUDE = -161.0156;
